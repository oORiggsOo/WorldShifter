...
#include "PDGDController/PdgdRoom5.h"
#include "Components/ArrowComponent.h"
#include "Components/StaticMeshComponent.h"

APdgdRoom5::APdgdRoom5()
{
	...
	Wall_Close3 = CreateDefaultSubobject<UStaticMeshComponent>("Wall_Close3");
	Wall_Close3->SetupAttachment(GeometryFolder.Get(), FName("Wall_Close3"));
}
